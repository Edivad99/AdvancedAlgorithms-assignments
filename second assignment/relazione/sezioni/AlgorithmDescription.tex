...
Since the last procedure in the list above must be performed at each iteration of the selection phase, it is trivial to assume that the final complexity is $\mathcal{O}(|V|²)$.
